...
class StakeAccountRead(BaseModel):
    ...
    account_balance_lamports: int | None = Field(
        description="Account balance in lamports.",
        examples=[14889939721],
    )
    credits_observed: int | None = Field(
        description="Observed credits.",
        examples=[718890781],
    )
    delegated_stake_lamports: int | None = Field(
        description="Delegated stake in lamports.",
        examples=[14887656841],
    )
    active_stake_lamports: int | None = Field(
    ...
    activation_epoch: int | None = Field(
        description="Activation epoch.",
        examples=[686],
    )
    deactivation_epoch: int | None = Field(description="Deactivation epoch.")
    staker_authority: str | None = Field(
        description="Staker authority pubkey.",
    ...
    rent_exempt_reserve_lamports: int | None = Field(
        description="Rent exempt reserve in lamports.",
        examples=[2282880],
    )
